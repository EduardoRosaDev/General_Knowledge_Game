...
<?php
	...
	// Get Question
	$query = "select * from questoes_portugues where question_number = $number";
	...
	// Get Choices
	$query = "select * from choices_portugues where question_number = $number";
...
<html>
  <head>
    <meta charset="utf-8" />
    <title>Português - Knowledge Game</title>
  ...
  <div class="cover-container d-flex w-100 h-100 mx-auto flex-column">
    ...
    <main>
		<h1 class="text-light text-center">Português</h1>
      <div class="container">
